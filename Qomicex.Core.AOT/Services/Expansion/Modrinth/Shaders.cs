...
internal sealed class Shaders(HttpClient http) : ModrinthBase(http)
{
    ...
    {
        return await base.SearchAsync(query, "shader", gameVersion, categories, loaders, index, page, pageSize);
    }
}
