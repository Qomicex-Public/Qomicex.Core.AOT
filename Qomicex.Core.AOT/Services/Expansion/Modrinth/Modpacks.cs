...
internal sealed class Modpacks(HttpClient http) : ModrinthBase(http)
{
    ...
    {
        return await base.SearchAsync(query, "modpack", gameVersion, categories, loaders, index, page, pageSize);
    }
}
