...
internal sealed class ResourcePacks(HttpClient http) : ModrinthBase(http)
{
    ...
    {
        return await base.SearchAsync(query, "resourcepack", gameVersion, categories, loaders, index, page, pageSize);
    }
}
